...
TARGET_TICKERS = [
    ...
    "JPM", "BRK-B", "HOOD", "TSLA", "TM", "GM", "JNJ", "LLY", "GEN"
...
def run_edgar_ingestion():
    ...
    for entity_name, cik in master_targets.items():
        ...
        try:
            ...
            pandas_gbq.to_gbq(submissions_df, "market_tracker.bronze_edgar_submissions", project_id=PROJECT, if_exists="append")
    ...
    if master_holdings:
        try:
            ...
            pandas_gbq.to_gbq(final_df, "market_tracker.bronze_edgar_13f", project_id=PROJECT, if_exists="append")
            logging.info(f"Successfully loaded {len(final_df)} institutional holdings to BigQuery.")
