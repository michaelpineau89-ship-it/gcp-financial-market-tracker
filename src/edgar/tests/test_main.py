    ...
    def test_get_latest_13f_url_success(self):
        ...
        mock_submissions_data = {
            "filings": {
                "recent": {
                    "form": ["13F-HR", "4", "4"],
                    "accessionNumber": ["0001104659-25-001234", "0001104659-25-001233", "0001104659-25-001232"],
...
class TestRunEdgarIngestionImpl:
        ...
        mock_get.side_effect = [
            ...
            MagicMock(json=lambda: {
                "filings": {
                    "recent": {
                        "form": ["13F-HR", "4"],
                        "accessionNumber": ["0001104659-25-001234", "0001104659-25-001233"],
    ...
    def test_run_edgar_ingestion_impl_partial_error(self, mock_get, mock_to_gbq):
        ...
        mock_get.side_effect = [
            ...
            MagicMock(json=lambda: {  # Second entity succeeds
                "filings": {
                    "recent": {
                        "form": ["13F-HR"],
...
class TestBigQueryIntegration:
    ...
    def test_submissions_loaded_to_bigquery(self, mock_to_gbq):
        ...
        pandas_gbq.to_gbq(mock_df, "test_table", project_id="test_project", if_exists="append")
