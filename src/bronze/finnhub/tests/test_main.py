...
class TestRunFinnhubIngestion:
    ...
    def test_run_finnhub_ingestion_http_success(self, mock_impl):
        ...
        response_body, status_code, headers = run_finnhub_ingestion(mock_request)
    ...
    @patch("main.run_finnhub_ingestion_impl")
    def test_run_finnhub_ingestion_http_with_request_data(self, mock_impl):
    ...
    @patch("main.run_finnhub_ingestion_impl")
    def test_run_finnhub_ingestion_http_error(self, mock_impl):
